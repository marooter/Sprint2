    ...
    return (
      ...
      <Ons.Card style={{ paddingLeft: '0%', backgroundImage: 'url(' + imgUrl + ')' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <br /><br /><br /><br /><br />
          <p>
            <Ons.Button onClick={this.loadPage.bind(this, Home)}style={{ backgroundColor: '	#FF3366' }}>กลับไปหน้าหลัก</Ons.Button>
          </p>
